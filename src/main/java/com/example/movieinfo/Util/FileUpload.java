...
//poster.jpg ==> poster.jpg 저장, poster.jpg 새로저장 ==> poster.jpg 기존내용되고 새로운 파일 저장
...
public class FileUpload {
  ...
  public void FileDelete(String imgLocation, String imageFileName) {
      ...
      String deleteFileName = imgLocation + imageFileName; //c:/movie/432-erw3342-4324.jpg
